...
# Agent Environment Doctor (SSoT: npx skills)
...
```bash
python3 ~/.agents/skills/agent-env-doctor/scripts/audit_environment.py
```
Outputs:
...
```bash
python3 ~/.agents/skills/agent-env-doctor/scripts/audit_environment.py --list-skills
```
...
```bash
python3 ~/.agents/skills/agent-env-doctor/scripts/audit_environment.py --list-disabled
```
...
```bash
python3 ~/.agents/skills/agent-env-doctor/scripts/audit_environment.py --install <repo_veya_paket>
# Example: python3 ~/.agents/skills/agent-env-doctor/scripts/audit_environment.py --install https://github.com/cloudflare/skills
```
...
```bash
python3 ~/.agents/skills/agent-env-doctor/scripts/audit_environment.py --update-skills
```
...
```bash
python3 ~/.agents/skills/agent-env-doctor/scripts/audit_environment.py --uninstall <skill_name>
```
To force a permanent purge on any skill (including local):
```bash
python3 ~/.agents/skills/agent-env-doctor/scripts/audit_environment.py --purge <skill_name>
```

### 6. Restoring / Re-enabling an Archived Skill
To restore a previously disabled skill back into active rotation:
```bash
python3 ~/.agents/skills/agent-env-doctor/scripts/audit_environment.py --enable <skill_name_veya_yolu>
# Example: python3 ~/.agents/skills/agent-env-doctor/scripts/audit_environment.py --enable azure/azure-kubernetes
```
...
```bash
python3 ~/.agents/skills/agent-env-doctor/scripts/audit_environment.py --clean-lock
# Alias: python3 ~/.agents/skills/agent-env-doctor/scripts/audit_environment.py --prune
```
